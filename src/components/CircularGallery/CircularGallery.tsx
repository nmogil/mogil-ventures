...
class Media {
  ...
  onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
    ...
    // Increase item size on mobile (slightly larger but not too much to avoid overlap)
    const isMobile = window.innerWidth < 768;
    const mobileScaleMultiplier = isMobile ? 1.25 : 1;
  ...
  createMedias(
    ...
    const defaultItems = [
      ...
      },
      {
        ...
        text: 'Portfolio Item 4'
      },
      {
        image: `https://picsum.photos/seed/5/800/600?grayscale`,
        text: 'Portfolio Item 5'
      },
      {
        image: `https://picsum.photos/seed/16/800/600?grayscale`,
        text: 'Portfolio Item 6'
      },
      {
        image: `https://picsum.photos/seed/17/800/600?grayscale`,
        text: 'Portfolio Item 7'
      },
      {
        image: `https://picsum.photos/seed/8/800/600?grayscale`,
        text: 'Portfolio Item 8'
      }
    ];
