      ...
      >
        <AnimatePresence>
          {activeValue === id && !disabled && (
            <motion.span
              className="absolute inset-0 h-full w-full bg-white/10 rounded-sm"
        ...
        <motion.span
          ...
          whileTap={{ scale: 0.95 }}
          className={cn(
            'relative z-[1] flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none data-[state=open]:bg-white/10 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
            inset && 'pl-8',
            className,
          )}
        >
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-xl bg-black/90 backdrop-blur-md border border-white/10 p-1 text-white shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-[--radix-dropdown-menu-content-transform-origin]',
      className,
    )}
    {...props}
  />
          ...
          <DropdownMenuPrimitive.Portal forceMount>
            ...
            >
              <motion.div
                key="dropdown-menu"
                className={cn(
                  'z-50 max-h-[var(--radix-dropdown-menu-content-available-height)] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-xl bg-black/90 backdrop-blur-md border border-white/10 p-1.5 text-white shadow-[0_20px_60px_rgba(0,0,0,0.8)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 origin-[--radix-dropdown-menu-content-transform-origin]',
                  className,
                )}
                initial={{
                  opacity: 0,
    ...
    return (
      ...
      >
        ...
        <motion.span
          ...
          whileTap={{ scale: 0.95 }}
          className={cn(
            'relative z-[1] flex cursor-pointer select-none items-center gap-2 rounded-lg px-3 py-2.5 text-sm text-white/80 outline-none transition-colors hover:text-white focus:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
            inset && 'pl-8',
            className,
          )}
        >
    ...
    return (
      ...
      >
        ...
        <motion.span
          ...
          whileTap={{ scale: 0.95 }}
          className={cn(
            'relative z-[1] flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none transition-colors focus:bg-white/10 focus:text-white data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
            className,
          )}
        >
